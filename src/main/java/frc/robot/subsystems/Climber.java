...
public class Climber extends SubsystemBase {
  ...
  /**
   * private static final DigitalInput LIMITSWITCH1_DIGITAL_INPUT = new
   * DigitalInput(6);//right private static final DigitalInput
   * LIMITSWITCH2_DIGITAL_INPUT = new DigitalInput(7);//left
   */

  // old limit switches
  // private static final DigitalInput LIMITSWITCH1_DIGITAL_INPUT = new
  // DigitalInput(6);//upper right
  // private static final DigitalInput LIMITSWITCH2_DIGITAL_INPUT = new
  // DigitalInput(7);//lower right
  // private static final DigitalInput LIMITSWITCH3_DIGITAL_INPUT = new
  // DigitalInput(8);//upper left
  // private static final DigitalInput LIMITSWITCH4_DIGITAL_INPUT = new
  // DigitalInput(9);//lower left
  ...
  public void updateShuffleboard() {
     ...
     */
    // old
    // SmartDashboard.putBoolean("LimitSwitch upper right active",
    // getUpperRightLimitSwitch());
    // SmartDashboard.putBoolean("LimitSwitch lower right active",
    // getLowerRightLimitSwitch());
    // SmartDashboard.putBoolean("LimitSwitch upper right active",
    // getUpperLeftLimitSwitch());
    // SmartDashboard.putBoolean("LimitSwitch upper right active",
    // getLowerRightLimitSwitch());
  }
   ...
   * 
   * public boolean getBrakeState() { return climberSolenoid.get(); }
   */
  ...
  /**
   * returns if the right side of the climber is down (based on mag Limit
   * Switches).
   */
  ...
  /**
   * returns if the left side of the climber is down (based on mag Limit
   * Switches).
   */
