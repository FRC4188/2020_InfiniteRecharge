...
public class ReintroRoutine extends SequentialCommandGroup {
  /** Creates a new ReintroRoutine. */
  public ReintroRoutine(Drivetrain drivetrain, Intake intake, Magazine magazine) {
    // Add your commands in the addCommands() call, e.g.
    // addCommands(new FooCommand(), new BarCommand());
    addCommands(
    new FollowTrajectory(drivetrain, new Waypoints(List.of(drivetrain.getPose(), WaypointsList.SkillsPowerPort.TO_REINTRO), true), 
